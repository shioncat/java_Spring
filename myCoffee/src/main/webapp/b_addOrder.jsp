...
<body>
<form action="b_OrderConfirm.jsp" method="post">
    ...
    <div class="wrapper grid">
          <div class="item big-box">
              ...
              <p>1號 黑咖啡 &emsp;&emsp; NT$150 &emsp; 數量<input class="inputorder"  type="number" name="A" value="0" step="1" min="0" max="100" />  
        	 <!-- 1號=A -->
          </div>
          <div class="item">
              <img src="images/menu2.jpg" alt="">
              <p>2號  那堤 &emsp;&emsp; NT$180</>  <!-- 2號=B -->
              <p>數量 &emsp; <input class="inputorder"  type="number" name="B" value="0" step="1" min="0" max="100" ></p> 
          </div>
          <div class="item">
              <img src="images/menu3.jpg" alt="">
              <p>3號 香橙檸檬塔 &emsp;&emsp; NT$80</>  
      ...
      <!-- ↑ 到這裡為止 ↑ -->
         ...
         <div class="container">
         		<p><a href="b_OrderIndex.jsp">訂單索引查詢</a></p>
          	 </div>
         </div>
